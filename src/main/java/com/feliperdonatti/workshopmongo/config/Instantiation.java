...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("2022-01-29"), "Partiu Viagem", "Vou viajar para São Paulo! Abraços", maria);
		Post post2 = new Post(null, sdf.parse("2021-12-18"), "Bom dia", "Acordei Feliz Hoje", maria);
